...
export default function Filter() {
  return(
    <div class="w-full md:w-2/3 shadow p-5 rounded-lg bg-white my-10">
    <div class="relative">
      ...
      <input type="text" placeholder="Search by country, variant ..." class="px-8 py-3 w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 text-sm"/>
        </div>
